...
function bbprioritycash_civicrm_install() {
  $params = array(
    ...
    'site_label' => 'URL of the processor service provider website',
    'api_label' => 'URL where the data will be posted',
    'recur_label' => 'URL where a recurring transaction will be posted',
    'button_label' => 'URL of a custom button graphic for the confirmation page',
    'site_test_label' => 'URL of the processor service provider website in test mode',
    'api_test_label' => 'URL where the data will be posted in test mode',
    'recur_test_label' => 'URL where a recurring transaction will be posted in test mode',
    'button_test_label' => 'URL of a custom button graphic for the confirmation page in test mode',
