...
function bbprioritycash_civicrm_install() {
  $params = array(
    ...
    'url_site_default_label' => 'http://URL of the processor service provider website',
    'url_api_default_label' => 'URL where the data will be posted',
    'url_recur_default_label' => 'URL where a recurring transaction will be posted',
    'url_button_default_label' => 'URL of a custom button graphic for the confirmation page',
    'url_site_test_default_label' => 'URL of the processor service provider website in test mode',
    'url_api_test_default_label' => 'URL where the data will be posted in test mode',
    'url_recur_test_default_label' => 'URL where a recurring transaction will be posted in test mode',
    'url_button_test_default_label' => 'URL of a custom button graphic for the confirmation page in test mode',
    'url_site_default' => '',
    'url_api_default' => '',
    'url_recur_default' => '',
    'url_button_default' => '',
